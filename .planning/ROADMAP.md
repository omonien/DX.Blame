...
Plans:
- [x] 07-01-PLAN.md — Refactor Engine and CommitDetail to dispatch through IVCSProvider
- [x] 07-02-PLAN.md — Refactor Navigation, Popup, Diff.Form and verify zero Git imports
