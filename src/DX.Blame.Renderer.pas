...
var
  ...
  /// <summary>
  /// Shared popup instance, lazily created on first hover/click. Exposed in
  /// the interface so TDXBlameRendererD13 (D13 renderer) can dismiss it from
  /// its INTACodeEditorEvents370 EditorMouseDown overload.
  /// </summary>
